...
class NaverQuickSpider(scrapy.Spider):
    ...
    def get_query_url(self, check_date, page):
        ...
        'http://news.naver.com/main/list.nhn?oid=032&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=10',
        ...
        'http://news.naver.com/main/list.nhn?oid=028&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=4',
        'http://news.naver.com/main/list.nhn?oid=028&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=5',
        'http://news.naver.com/main/list.nhn?oid=028&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=6',
        ...
        'http://news.naver.com/main/list.nhn?oid=020&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=4',
        'http://news.naver.com/main/list.nhn?oid=020&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=5',
        ...
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=5',
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=6',
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=7',
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=8',
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=9',
        'http://news.naver.com/main/list.nhn?oid=025&listType=paper&mid=sec&mode=LPOD&date='+ check_date + '&page=10',
