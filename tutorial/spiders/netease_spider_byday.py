...
class NeteaseSpiderByDay(scrapy.Spider):
    name = '163_byday'
    ...
    Constructor
    '''
    def __init__(self, get_date = '', *args, **kwargs):
        self.s_date = get_date
        self.start_urls = [self.get_query_url(self.s_date)]
        super(NeteaseSpiderByDay, self).__init__(*args, **kwargs)
        print self.start_urls

    '''
    Get the query url
    '''
    def get_query_url(self, get_date):
        ...
        jsurl = 'http://snapshot.news.163.com/wgethtml/http+!!news.163.com!special!0001220O!news_json.js/'+ get_date +'/0.js'
        return jsurl
    '''
    Starting point.
